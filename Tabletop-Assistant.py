...
print()
mainmenu_items = ["1:Loot Generator", "2:Potion Maker", "3:Shop", "4:Bag",
"5:Quit"]

for mainselection in mainmenu_items:
print(mainselection)

mainmenu_selection = input() #The user makes a selection it will the call
upon the selected function, or quit the program
...
print("Please choose from the following options:") #If the user doesn't
a correct value it will continue asking
...
print("----------------------")
for bag_content in player_bag: # neatly display bag content and gold plater
bag and gold found at beginning of the program
print(bag_content)
print("you have " + str(player_gold) + " gold in your bag")
print("----------------------")
print()
...
for loot_select in lootmenu_selection_list: # selection for which generator to
activte
print(loot_select)
...
def potionmaker():
  ingredient_list_herb = ("Moonflower", "Nightshade Berries", "Lavender Sprig",
"Wolfsbane", "Ginseng Root", "Sage Leaves", "Dandelion Root", "Belladonna",
"Thyme", "Rosemary", "Mandrake Root", "Basilisk Vine", "Marigold Petals", "AloeVera Gel", "Yarrow")

ingredient_list_element = ("Fairy Dust", "Mermaid Tears", "Essence of Night",
"Essence of Fire", "Shadow Moss", "Elven Wine", "Phoenix Feather", "Cloud Essence",
"Pixie Wings", "Thunderstorm Water", "Eternal Flame Ember", "Rainbow Droplet")
...
print(f"Not enough gold to buy {shopAnswer}. You need {item_price -
player_gold} more gold.")
